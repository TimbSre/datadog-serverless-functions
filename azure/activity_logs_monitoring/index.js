...
const DD_SERVICE = process.env.DD_SERVICE || 'b2c_activity_logs'; // Replace service name from azure to the name that fits to your policies. Service name azure is too broad.
